...
public class Line extends Shape {
	...
	public String toString() {
		//return startPoint + "-->" + endPoint + ", " + isSelected();
		return "LINE: ( " + startPoint.getX() + " , " + startPoint.getY() + " )" + " --> " + "( " + endPoint.getX() + " , " + endPoint.getY() + " )" + " , select= " + isSelected() + " , color=[ " + getColor().getRed() + "," + getColor().getGreen() + "," + getColor().getBlue() + " ]";
	}
